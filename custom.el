(custom-set-variables
 ...
 '(TeX-PDF-mode t nil nil "Customized with use-package tex")
 '(TeX-auto-save t nil nil "Customized with use-package tex")
 '(TeX-byte-compile t nil nil "Customized with use-package tex")
 '(TeX-clean-confirm nil nil nil "Customized with use-package tex")
 '(TeX-master (quote dwim) nil nil "Customized with use-package tex")
 '(TeX-parse-self t nil nil "Customized with use-package tex")
 '(TeX-source-correlate-mode t nil nil "Customized with use-package tex")
 '(TeX-view-program-selection (quote ((output-pdf "Evince") (output-html "xdg-open"))) nil nil "Customized with use-package tex")
 ...
 '(erc-autojoin-channels-alist
   (quote
    (("freenode.net" "#archlinux" "#bash" "#bitcoin" "#emacs" "#gentoo" "#i3" "#latex" "#org-mode" "#python" "#sway"))) nil nil "Customized with use-package erc")
