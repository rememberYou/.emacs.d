...
LSP is great! To use it, make sure you install =dart= with your package manager and
to configure the LSP package.
...
Dart SDK dir. Finally, if you use Flutter, do not forget to install it too.
...
as LSP server is enough. To use it, make sure you install it with your package
manager and to configure the LSP package.
