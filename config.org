...
*NOTE:* SEE the [[https://github.com/mhayashi1120/Emacs-langtool/pull/41][pull request]] that I did to fix the =langtool-disabled-rules=
issue with the new LanguageTool API, until this pull request it's merged.
