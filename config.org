...
I need to debug this; I seem the one and only person to got this issue with dbus
and libnotify with Emacs...

#+BEGIN_SRC emacs-lisp :tangle
  (use-package alert)

  (defun do-notify (nickname message)
    (alert message :title nickname))

  (setq alert-libnotify-command "/home/someone/bin/alert")
