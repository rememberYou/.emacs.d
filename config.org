...
#+BEGIN_SRC emacs-lisp :tangle yes
  ...
  (use-package company-lsp
    :custom
    (company-lsp--completion-cache t)
...
I'm a big fan of [[https://github.com/arcticicestudio/nord-emacs][nord-theme]] and combined with [[https://github.com/seagle0128/doom-modeline][doom-modeline]], it's just happiness.
...
#+BEGIN_SRC emacs-lisp :tangle yes
  ...
  ;; NOTE: you must run `M-x all-the-icons-install-fonts` the first time.
  ...
  (use-package all-the-icons-ivy
    ...
    :custom (all-the-icons-ivy-file-commands '(counsel-git
                                               counsel-dired-jump
                                               counsel-find-file
                                               counsel-file-jump
