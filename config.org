...
In order to have a fast and stable environment, I recommend using [[https://github.com/andrew-christianson/lsp-python-ms][lsp-python-ms]]
...
#+begin_src emacs-lisp :tangle yes
  (use-package org-journal
    ...
    (org-journal-dir "~/.personal/journal/2019/")
