...
sure you install it with your package manager and configure the LSP package.

#+begin_src emacs-lisp
  (use-package ccls
    :after projectile
    :ensure-system-package (ccls . "yay -S ccls")
...
Emacs, the [[https://github.com/Kitware/CMake/blob/master/Auxiliary/cmake-mode.el][cmake-mode]] package with the installation of the [[https://github.com/regen100/cmake-language-server][cmake-language-server]]
LSP server is sufficient.

#+begin_src emacs-lisp
  (use-package cmake-mode
    :ensure-system-package (cmake-language-server . "yay -S cmake-language-server")
